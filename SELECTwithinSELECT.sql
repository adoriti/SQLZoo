...
-- has 11% of the population of Germany. Show the name and the population of each country in Europe.
...
-- 9. Find the continents where all countries have a population <= 25000000. Then find the names of
-- the countries associated with these continents. Show name, continent and population.
